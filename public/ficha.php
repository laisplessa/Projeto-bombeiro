...
$outrasVezes = ($_POST["outras_vezes"] === "sim") ? true : false;
$quantoTempo = $_POST["quanto_tempo"];
$problemaSaude = ($_POST["problema_saude"] === "sim") ? true : false;
...
$medicacaoGestacao = ($_POST["medicacao_gestacao"] === "sim") ? true : false;
$nomeMedico = $_POST["nome_medico"];
$complicacoes = ($_POST["complicacoes"] === "sim") ? true : false;
$primeiroFilho = ($_POST["primeiro_filho"] === "sim") ? true : false;
...
$sqlFicha = "INSERT INTO ficha (oq_aconteceu, outras_vezes, quanto_tempo, problema_saude, quais, medicacao, ultima_medicacao, quais_medicacao, alergico, especifique, ingeriu, horario_ingeriu,
    ...
    '$ataduras', '$ataduras8', '$ataduras12', '$ataduras20', '$ataduraQuantidade', '$mantaAluminizada', '$mantaQuantidade', '$cateterOculos', '$cateterQuantidade', '$pasDea', '$pasQuantidade','$compressaComum', '$compressaQuantidade', '$sondaAspiracao', '$sondaQuantidade', '$kits', '$kitsH', '$kitsP', '$kitsQ', '$kitsQuantidade', '$soroFisiologico', '$soroQuantidade', '$luvasDescartaveis', '$luvasQuantidade', '$talasPap', '$talasPapp', '$talasPapg', '$talasQuantidade', '$mascarasDescartaveis', '$mascaraQuantidade', '$outroMaterial', '$outroM', '$outromQuantidade',
  ...
  $run_query = mysqli_query($con, $sqlFicha);
  echo $run_query;
