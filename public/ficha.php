...
$numeroCorpo2 = isset($_POST["numerocorpo2"]) ? $_POST["numerocorpo2"] : 'NULL';
$fratura2 = isset($_POST["fratura2"]) ? $_POST["fratura2"] : 'NULL';
$ferimento2 = isset($_POST["ferimento2"]) ? $_POST["ferimento2"] : 'NULL';
$hemorragias2 = isset($_POST["hemorragias2"]) ? $_POST["hemorragias2"] : 'NULL';
$esviceracao2 = isset($_POST["esviceracao2"]) ? $_POST["esviceracao2"] : 'NULL';
$fab2 = isset($_POST["fab2"]) ? $_POST["fab2"] : 'NULL';
$amputacao2 = isset($_POST["amputacao2"]) ? $_POST["amputacao2"] : 'NULL';
$queimadura12 = isset($_POST["queimadura1_2"]) ? $_POST["queimadura1_2"] : 'NULL';
$queimadura22 = isset($_POST["queimadura2_2"]) ? $_POST["queimadura2_2"] : 'NULL';
$queimadura32 = isset($_POST["queimadura3_2"]) ? $_POST["queimadura3_2"] : 'NULL';
$numeroCorpo3 = isset($_POST["numerocorpo3"]) ? $_POST["numerocorpo3"] : 'NULL';
$fratura3 = isset($_POST["fratura3"]) ? $_POST["fratura3"] : 'NULL';
$ferimento3 = isset($_POST["ferimento3"]) ? $_POST["ferimento3"] : 'NULL';
$hemorragias3 = isset($_POST["hemorragias3"]) ? $_POST["hemorragias3"] : 'NULL';
$esviceracao3 = isset($_POST["esviceracao3"]) ? $_POST["esviceracao3"] : 'NULL';
$fab3 = isset($_POST["fab3"]) ? $_POST["fab3"] : 'NULL';
$amputacao3 = isset($_POST["amputacao3"]) ? $_POST["amputacao3"] : 'NULL';
$queimadura13 = isset($_POST["queimadura1_3"]) ? $_POST["queimadura1_3"] : 'NULL';
$queimadura23 = isset($_POST["queimadura2_3"]) ? $_POST["queimadura2_3"] : 'NULL';
$queimadura33 = isset($_POST["queimadura3_3"]) ? $_POST["queimadura3_3"] : 'NULL';


$Localferimento = isset($_POST["local_ferimento"]) ? $_POST["local_ferimento"] : 'NULL';
$ladoFerimento = isset($_POST["lado_ferimento"]) ? $_POST["lado_ferimento"] : 'NULL';
$faceFerimento = isset($_POST["face_ferimento"]) ? $_POST["face_ferimento"] : 'NULL';
$tipoFerimento = isset($_POST["tipo_ferimento"]) ? $_POST["tipo_ferimento"] : 'NULL';
$Localferimento2 = isset($_POST["local_ferimento2"]) ? $_POST["local_ferimento2"] : 'NULL';
$lado = isset($_POST["lado_ferimento"]) ? $_POST["lado_ferimento"] : 'NULL';
$face = isset($_POST["face_ferimento"]) ? $_POST["face_ferimento"] : 'NULL';
$tipo = isset($_POST["tipo_ferimento"]) ? $_POST["tipo_ferimento"] : 'NULL';
$Localferimento3 = isset($_POST["local_ferimento3"]) ? $_POST["local_ferimento3"] : 'NULL';
$lado3 = isset($_POST["lado_ferimento3"]) ? $_POST["lado_ferimento3"] : 'NULL';
$face3 = isset($_POST["face_ferimento3"]) ? $_POST["face_ferimento3"] : 'NULL';
$tipo3 = isset($_POST["tipo_ferimento3"]) ? $_POST["tipo_ferimento3"] : 'NULL';
$Localferimento4 = isset($_POST["local_ferimento4"]) ? $_POST["local_ferimento4"] : 'NULL';
$lado4 = isset($_POST["lado_ferimento4"]) ? $_POST["lado_ferimento4"] : 'NULL';
$face4 = isset($_POST["face_ferimento4"]) ? $_POST["face_ferimento4"] : 'NULL';
$tipo4 = isset($_POST["tipo_ferimento4"]) ? $_POST["tipo_ferimento4"] : 'NULL';
$Localferimento5 = isset($_POST["local_ferimento5"]) ? $_POST["local_ferimento5"] : 'NULL';
$lado5 = isset($_POST["lado_ferimento5"]) ? $_POST["lado_ferimento5"] : 'NULL';
$face5 = isset($_POST["face_ferimento5"]) ? $_POST["face_ferimento5"] : 'NULL';
$tipo5 = isset($_POST["tipo_ferimento5"]) ? $_POST["tipo_ferimento5"] : 'NULL';
